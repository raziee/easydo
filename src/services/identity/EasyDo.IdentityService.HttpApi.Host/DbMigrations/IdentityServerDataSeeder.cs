...
//         await CreateApiResourceAsync("Administration", commonApiUserClaims);
...
//         await CreateApiScopeAsync("Administration");
...
//             var AdministrationRootUrl = _configuration[$"IdentityServerClients:Administration:RootUrl"].TrimEnd('/');
...
//                     $"{AdministrationRootUrl}/swagger/oauth2-redirect.html", // Administration redirect uri
...
//                     AdministrationRootUrl.RemovePostFix("/"),
